...
export default function BookingRequestsPanel({
    ...
    const getPageTitle = () => {
        if (isAdmin) return "All Booking Requests";
        return "Booking Requests";
    };

    const getPageDescription = () => {
        if (isAdmin)
            return "Manage all customer and mechanic appointments and installations.";
        return "Manage your appointments and installations.";
    };
    ...
    return (
        <SearchProvider types={[]}>
            ...
            <div className="p-6 max-w-7xl mx-auto">
                {/* Back to Dashboard Button - Only show for admin users */}
                {isAdmin && (
                    <Link
