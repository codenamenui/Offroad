                ...
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-2/3">
                    <div className="grid grid-cols-5 gap-4">
                      ...
                      <span>Status</span>
                      <span>
                        {userType === "customer" ? "Mechanic" : "Customer"}
                      </span>
                    </div>
                  </th>
                </tr>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap w-1/3">
                        <div>
                          <div className="text-sm font-medium text-gray-900">
                            {group.vehicle?.name || "Unknown Vehicle"}
                          </div>
                              ...
                              <div
                                className={`w-2 h-2 rounded-full mr-2 ${
                                  group.status?.toLowerCase() === "pending"
                                    ...
                                    ? "bg-red-600"
                                    : group.status?.toLowerCase() === "mixed"
                                    ? "bg-orange-600"
                                    : "bg-gray-600"
                                }`}
                              ></div>
                            ...
                            {userType === "customer" ? (
                              <div className="flex items-center">
                                <div className="w-8 h-8 bg-gray-300 rounded-full flex-shrink-0 flex items-center justify-center overflow-hidden mr-3">
                                  {group.mechanic?.url ? (
                                    <Image
                                      src={group.mechanic.url}
                                      alt={group.mechanic.name || "Mechanic"}
                                      width={32}
                                      height={32}
                                    ...
                                    <span className="text-xs font-medium text-gray-600">
                                      {group.mechanic?.name?.charAt(0) || "M"}
                                    </span>
                                  )}
                                </div>
                                <div className="min-w-0">
                                  <div className="text-sm font-medium text-gray-900 truncate">
                                    {group.mechanic?.name || "Unassigned"}
                                  </div>
                                  <div className="text-xs text-gray-500 truncate">
                                    {group.mechanic?.email || "No email"}
                                  </div>
                                </div>
                              </div>
                            ) : (
                              <div className="flex items-center">
                                ...
                                <div className="min-w-0">
                                  <div className="text-sm font-medium text-gray-900 truncate">
                                    {group.bookings[0]?.users?.name ||
                                      "Unknown Customer"}
                                  </div>
                                  <div className="text-xs text-gray-500 truncate">
                                    {group.bookings[0]?.users?.email ||
                                      "No email"}
                                  </div>
                                </div>
                              </div>
